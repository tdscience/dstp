...
In this session, we will explore how to find, download, import, and clean transport-related datasets. Transport data comes from various sources such as government agencies, open data portals, and crowd-sourced platforms. We will learn practical techniques using R to access and prepare these data for analysis.
...
Once downloaded, data often need cleaning. Common issues include missing values, inconsistent formats, and inconsistent coordinate systems.
